...
// Fri Mar 27 12:25:23 2026 by ROOT version 6.36.02
// from TTree ClusterTree/ClusterTree
// found on file: /data/dsmith/weights/user.cdelitzs.45207441._000199.mltree_cluster_calo.root
//////////////////////////////////////////////////////////
...
#ifdef GetWeights_cxx
GetWeights::GetWeights(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/dsmith/weights/user.cdelitzs.45207441._000199.mltree_cluster_calo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/dsmith/weights/user.cdelitzs.45207441._000199.mltree_cluster_calo.root");
      }
...
Int_t GetWeights::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GetWeights::LoadTree(Long64_t entry)
{
...
void GetWeights::Init(TTree *tree)
{
...
void GetWeights::Show(Long64_t entry)
{
...
Int_t GetWeights::Cut(Long64_t entry)
{
