...
//by  b_branchname->GetEntry(ientry); //read only this branch
 ...
 1.00000000e+03};
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      h_fracEm->Fill(cluster_ENG_FRAC_EM_INCL);
   ...
   h2_jet_pt_eta->Scale(1.0/h2_jet_pt_eta->Integral());
   ...
   TFile *fout = new TFile("/home/dsmith/CalibPU/weights/mc_hist/mc_hist.root", "RECREATE");
   ...
   h_mu->Draw();
   mu->SaveAs("/home/dsmith/CalibPU/weights/mc_hist/mc_mu.png");
   ...
   c2->SaveAs("/home/dsmith/CalibPU/weights/mc_hist/mc_cluster_eta_pt.png");
   ...
   c3->SaveAs("/home/dsmith/CalibPU/weights/mc_hist/mc_jet_eta_pt.png");
   }
