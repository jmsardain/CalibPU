...
// Fri Mar 27 12:36:24 2026 by ROOT version 6.36.02
// from TTree ClusterTree/ClusterTree
// found on file: /data/dsmith/weights/MC20d_JZ0_putagging_snapshot.root
//////////////////////////////////////////////////////////
...
#ifdef mcHist_cxx
mcHist::mcHist(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/dsmith/weights/MC20d_JZ0_putagging_snapshot.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/dsmith/weights/MC20d_JZ0_putagging_snapshot.root");
      }
...
Int_t mcHist::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mcHist::LoadTree(Long64_t entry)
{
...
void mcHist::Show(Long64_t entry)
{
...
Int_t mcHist::Cut(Long64_t entry)
{
