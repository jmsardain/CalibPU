...
// Thu Apr 23 12:03:41 2026 by ROOT version 6.36.02
...
#ifdef dataHist_cxx
dataHist::dataHist(TTree *tree) : fChain(0) 
{
...
Int_t dataHist::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dataHist::LoadTree(Long64_t entry)
{
...
void dataHist::Show(Long64_t entry)
{
...
Int_t dataHist::Cut(Long64_t entry)
{
