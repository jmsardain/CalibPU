...
// Thu Apr 23 11:58:07 2026 by ROOT version 6.36.02
// from TTree ClusterTree/ClusterTree
// found on file: /data/jmsardain/CalibPU/new/run/user.jmsardain.00339435.physics_Main.Ntuples_20April26_eta2p0_v1_mltree_cluster_calo.root/user.jmsardain.49860379._000001.mltree_cluster_calo.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         cluster_ENG_FRAC_EM_INCL;
   ...
   ApplyWeights(TTree *tree=0);
   virtual ~ApplyWeights();
...
#ifdef ApplyWeights_cxx
ApplyWeights::ApplyWeights(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/jmsardain/CalibPU/new/run/user.jmsardain.00339435.physics_Main.Ntuples_20April26_eta2p0_v1_mltree_cluster_calo.root/user.jmsardain.49860379._000001.mltree_cluster_calo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/jmsardain/CalibPU/new/run/user.jmsardain.00339435.physics_Main.Ntuples_20April26_eta2p0_v1_mltree_cluster_calo.root/user.jmsardain.49860379._000001.mltree_cluster_calo.root");
      }
...
Int_t ApplyWeights::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ApplyWeights::LoadTree(Long64_t entry)
{
...
void ApplyWeights::Init(TTree *tree)
{
...
void ApplyWeights::Show(Long64_t entry)
{
...
Int_t ApplyWeights::Cut(Long64_t entry)
{
