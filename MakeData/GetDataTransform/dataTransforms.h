...
// Fri Mar 20 21:27:33 2026 by ROOT version 6.36.02
// from TTree ClusterTree/ClusterTree
// found on file: /data/dsmith/data_for_test/user.cdelitzs.45207441._000199.mltree_cluster_calo.root
//////////////////////////////////////////////////////////

#ifndef dataTransforms_h
#define dataTransforms_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   dataTransforms(TTree *tree=0);
   virtual ~dataTransforms();
...
#ifdef dataTransforms_cxx
dataTransforms::dataTransforms(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/dsmith/data_for_test/user.cdelitzs.45207441._000199.mltree_cluster_calo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/dsmith/data_for_test/user.cdelitzs.45207441._000199.mltree_cluster_calo.root");
      }
...
Int_t dataTransforms::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dataTransforms::LoadTree(Long64_t entry)
{
...
void dataTransforms::Init(TTree *tree)
{
...
void dataTransforms::Show(Long64_t entry)
{
...
Int_t dataTransforms::Cut(Long64_t entry)
{
...
#endif // #ifdef dataTransforms_cxx
