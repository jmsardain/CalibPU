...
// Sun Feb  1 13:52:48 2026 by ROOT version 6.36.02
// from TTree JetTree/One entry per jet
// found on file: /data/jmsardain/CalibPU/datasets/pu/JetTree_all_test.root
//////////////////////////////////////////////////////////
...
#ifdef DoPlot_cxx
DoPlot::DoPlot(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/jmsardain/CalibPU/datasets/pu/JetTree_all_test.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/jmsardain/CalibPU/datasets/pu/JetTree_all_test.root");
      }
...
Int_t DoPlot::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DoPlot::LoadTree(Long64_t entry)
{
...
void DoPlot::Show(Long64_t entry)
{
...
Int_t DoPlot::Cut(Long64_t entry)
{
