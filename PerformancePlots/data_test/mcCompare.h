...
// Wed Mar 18 16:51:39 2026 by ROOT version 6.36.02
// from TTree ClusterTree/ClusterTree
// found on file: /data/dsmith/mc_for_test/MC20d_JZ0_putagging_snapshot.root
//////////////////////////////////////////////////////////
...
#ifdef mcCompare_cxx
mcCompare::mcCompare(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/dsmith/mc_for_test/MC20d_JZ0_putagging_snapshot.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/dsmith/mc_for_test/MC20d_JZ0_putagging_snapshot.root");
      }
...
Int_t mcCompare::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mcCompare::LoadTree(Long64_t entry)
{
...
void mcCompare::Init(TTree *tree)
{
...
void mcCompare::Show(Long64_t entry)
{
...
Int_t mcCompare::Cut(Long64_t entry)
{
