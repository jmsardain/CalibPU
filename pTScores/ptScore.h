...
// Fri May 22 13:41:26 2026 by ROOT version 6.36.02
// from TTree JetTree/
// found on file: /data/jmsardain/CalibPU/trainings/pu/ckpts/Apr212026/final_new.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        predicted_response[59];   //[npredicted_response]
   Int_t           nerror_on_response;
   Double_t        error_on_response[59];   //[nerror_on_response]
...
#ifdef ptScore_cxx
ptScore::ptScore(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/jmsardain/CalibPU/trainings/pu/ckpts/Apr212026/final_new.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/jmsardain/CalibPU/trainings/pu/ckpts/Apr212026/final_new.root");
      }
...
Int_t ptScore::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ptScore::LoadTree(Long64_t entry)
{
...
void ptScore::Show(Long64_t entry)
{
...
Int_t ptScore::Cut(Long64_t entry)
{
