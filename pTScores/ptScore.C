...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH1D* h_score10pt15 = new TH1D("Data", "jetCalpT 10-15 GeV", 100, 0, 1);
   TH1D* h_score15pt22 = new TH1D("Data", "jetCalpT 15-22 GeV", 100, 0, 1);
   TH1D* h_score22pt33 = new TH1D("Data", "jetCalpT 22-33 GeV", 100, 0, 1);
   TH1D* h_score33pt50 = new TH1D("Data", "jetCalpT 33-50 GeV", 100, 0, 1);
   TH1D* h_score50pt76 = new TH1D("Data", "jetCalpT 50-76 GeV", 100, 0, 1);
   TH1D* h_score76pt115 = new TH1D("Data", "jetCalpT 76-115 GeV", 100, 0, 1);
   TH1D* h_score115pt175 = new TH1D("Data", "jetCalpT 115-175 GeV", 100, 0, 1);
   TH1D* h_score175pt265 = new TH1D("Data", "jetCalpT 175-265 GeV", 100, 0, 1);
   TH1D* h_score265pt400 = new TH1D("Data", "jetCalpT 265-400 GeV", 100, 0, 1);
   TH1D* h_score400pt630 = new TH1D("Data", "jetCalpT 400-630 GeV", 100, 0, 1);
   ...
   h_score10pt15->Draw();
   c1->SaveAs("./Data/Score10pT15.png");
   c1->Close();
   ...
   h_score15pt22->Draw();
   c2->SaveAs("./Data/Score15pT22.png");
   c2->Close();
   ...
   h_score22pt33->Draw();
   c3->SaveAs("./Data/Score22pT33.png");
   c3->Close();
   ...
   h_score33pt50->Draw();
   c4->SaveAs("./Data/Score33pT50.png");
   c4->Close();
   ...
   h_score50pt76->Draw();
   c5->SaveAs("./Data/Score50pT76.png");
   c5->Close();
   ...
   h_score76pt115->Draw();
   c6->SaveAs("./Data/Score76pT115.png");
   c6->Close();
   ...
   c7->SaveAs("./Data/Score115pT175.png");
   c7->Close();
   ...
   c8->SaveAs("./Data/Score175pT265.png");
   c8->Close();
   ...
   c9->SaveAs("./Data/Score265pT400.png");
   c9->Close();
   ...
   c10->SaveAs("./Data/Score400pT630.png");
   c10->Close();
}
