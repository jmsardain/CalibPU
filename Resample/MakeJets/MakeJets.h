...
// Fri Jan 23 09:45:05 2026 by ROOT version 6.36.02
// from TTree ClusterTree/ClusterTree
// found on file: /data/jmsardain/CalibPU/MC20d_JZ0_putagging_snapshot.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        zRel;
   Double_t        zT;
 //tuple<double,double,double> *zVars;
   Double_t        _2;
   Double_t        _1;
   Double_t        _0;
   ...
   MakeJets(TTree *tree=0);
   virtual ~MakeJets();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString JZSlice);
   virtual bool     Notify();
...
#ifdef MakeJets_cxx
MakeJets::MakeJets(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/jmsardain/CalibPU/MC20d_JZ0_putagging_snapshot.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/jmsardain/CalibPU/MC20d_JZ0_putagging_snapshot.root");
      }
...
Int_t MakeJets::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MakeJets::LoadTree(Long64_t entry)
{
...
void MakeJets::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("_2", &_2, &b_zVars__2);
   fChain->SetBranchAddress("_1", &_1, &b_zVars__1);
   fChain->SetBranchAddress("_0", &_0, &b_zVars__0);
   Notify();
}

bool MakeJets::Notify()
{
...
void MakeJets::Show(Long64_t entry)
{
...
Int_t MakeJets::Cut(Long64_t entry)
{
